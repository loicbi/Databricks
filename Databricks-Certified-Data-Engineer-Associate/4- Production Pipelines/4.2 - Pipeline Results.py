...
# MAGIC %sql
# MAGIC SELECT * FROM hive_metastore.demo_books_store_dlt_db.cn_daily_customer_books

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM hive_metastore.demo_books_store_dlt_db.fr_daily_customer_books
